...
namespace Webservices.Controllers
{
    public class Employees1Controller : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmployeeId,Name,Email,DepartementId")] Employee employee)
        {
            ...
            ViewBag.DepartementId = new SelectList(db.Departements, "DepartementId", "Name", employee.DepartementId);
            return View(employee);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmployeeId,Name,Email,DepartementId")] Employee employee)
        {
            if (ModelState.IsValid)
            {
